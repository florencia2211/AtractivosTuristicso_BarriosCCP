...
lyr_HereWegoTerrain_0.setVisible(true);lyr_BARRIOS_SELECCIONADOS_1.setVisible(false);lyr_AtractivosTuristicos_2.setVisible(true);
...
lyr_BARRIOS_SELECCIONADOS_1.set('fieldLabels', {'Id': 'no label', 'Nombre': 'no label', 'Area': 'inline label - always visible', 'hab_m2': 'no label', 'Sum_Poblac': 'no label', 'av_hab': 'no label', 'Long_tLic': 'no label', 'Long_tNLic': 'no label', 'Suma_Trans': 'no label', 'porc_cober': 'no label', 'Distance': 'no label', 'LongcicloK': 'no label', 'Long_rvial': 'no label', });
